               ...
               <div class="col-md-2 col-sm-2">
                  <div class="logo">
                     <a href="{{ route('user.home') }}">
                        <img src="{{ asset("asset/client/images/" . setting_website()->logo) }}" alt="VH Clothings">
                     </a>
                  </div>
               </div>
                  ...
                  <div class="header_bottom">
                     <ul class="option">
                        ...
                        <li class="option-cart">
                           <a href="{{ route('cart.index') }}" class="cart-icon">cart <span class="cart_no">{{count(\Cart::getContent())}}</span></a>
                        </li>
                     </ul>

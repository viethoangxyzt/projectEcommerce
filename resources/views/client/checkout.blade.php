                ...
                <div class="your-details row">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control form-select" id="city" name="city">
                      ...
                      <option value="{{ $item['ProvinceID'] }}" @if ( $item['ProvinceID']==$city) selected @endif>{{ $item['NameExtension'][1] }}</option>
                      @endforeach
                    </select>
                    @if ($errors->get('city'))
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control form-select" id="district" name="district">
                      ...
                      <option value="{{ $item['DistrictID'] }}" @if ( $item['DistrictID']==$district) selected @endif>{{ $item['DistrictName'] }}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control form-select" id="ward" name="ward">
                      ...
                      <option value="{{ $item['WardCode'] }}" @if ( $item['WardCode']==$ward) selected @endif>{{ $item['WardName'] }}</option>
                      @endforeach
                    </select>
                    @if ($errors->get('ward'))
              ...
              <li class="steps active">
                ...
                <div class="step-description">
                  <div class="your-details row">
                    ...
                    <?php
                    $weight = $product->attributes->get('weight', 200);
                    $totalWeight += $product->quantity * $weight;
                    ?>
                    @endforeach
                    <input id="total-weight" value="{{$totalWeight}}" hidden>
                    <div class="info-order">

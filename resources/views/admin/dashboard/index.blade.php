      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            <!-- small box -->
           <x-box-dashboard :data="$revenue" title="Tổng Doanh Thu" route="doanhthu" boxtype="warning" icon="ion-cash"/>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$orders" title="Tổng Đơn Hàng" route="donhang" boxtype="success" icon="ion-bag"/>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$admins" title="Tổng Nhân Sự" route="sanpham" boxtype="info" icon="ion-person"/>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$profit" title="Tổng Lợi Nhuận" route="loinhuan" boxtype="danger" icon="ion-cash"/>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$products" title="Tổng Sản Phẩm Tồn Kho" route="tonkho" boxtype="primary" icon="ion-shirt"/>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <x-box-dashboard :data="$users" title="Tổng Khách Hàng" route="khachhang" boxtype="warning" icon="ion-person"/>
          </div>
          <div class="col-md-12">
             <!-- STACKED BAR CHART -->
